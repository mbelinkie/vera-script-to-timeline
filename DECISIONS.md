...
| D-P003 | Pending producer | Timeline frame rate, resolution, and audio sample rate | Must be explicit before timeline fixtures or delivery behavior depend on them. |
